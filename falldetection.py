...
def fall_detection(video_path):
  # Load the model
  model = keras.models.load_model('./fall3.h5')
  # Define actions and colors for visualization
  actions = ['Fall', 'Not Fall']
    ...
    while cap.isOpened():
      ...
      if len(sequence) == 160:
        ...
        if res[np.argmax(res)] > threshold:
          # if actions[np.argmax(res)] == 'Fall':
          #   cv2.imwrite('output.png', image)
          #   return imger('output.png')
          if len(sentence) > 0:
